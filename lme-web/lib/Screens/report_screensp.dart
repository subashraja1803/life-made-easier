...
class ReportScreenssp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: ReportScreensp(),
    );
  }
}
class ReportScreensp extends StatefulWidget {
  @override
  _ReportScreenspState createState() => _ReportScreenspState();
}
...
class _ReportScreenspState extends State<ReportScreensp> {
                      ...
                      child: Column(
                        children: [
                          TextField(
                            ...
                            onChanged: (value){
                              _firestoreInstance.collection('Report').doc('$email').set({'Service ID' : value});
                            },
                          ),
                          SizedBox(
                            height: 15.0,
                          ...
                          TextField(
                            ...
                            onChanged: (value){
                              name = value;
                              _firestoreInstance.collection('Report').doc('$email').update({'Customer Name' : value});
                            },
                          ),
                          SizedBox(
                            height: 15.0,
                          ...
                          TextField(
                            ...
                            onChanged: (value){
                              detail = value;
                              _firestoreInstance.collection('Report').doc('$email').update({'Details' : value});
                            },
                          ),
                          SizedBox(
                            height: 15.0,
